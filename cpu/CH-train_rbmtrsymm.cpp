...
int main(int argc, char* argv[])
{
  ...
  const std::string prefix = path + "RBMTrSymmCH-Nv" + nvstr + "A" + alphastr + "Hf" + hfstr + "V" + vestr;
  ...
  spinhalf::TFIChain<AnsatzTraits<Ansatz::RBMSymm, double> > Hsampler(machine, h, J, nBlocks, seed);
